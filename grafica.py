...
plt.ylabel(r'$f(x)')
plt.xlabel(r'$x')
plt.title('Solución a ecuación de advección: Paralela')
plt.legend()
...
plt.hist(datosWalk,bins=100,density=True,label='Serial',color='red')
plt.title('Caminata histograma')
plt.hist(datosWalkomp,bins=100,density=True,label='Paralela',color='blue')
plt.title('Caminata histograma Paralela vs Serial')
plt.legend()
